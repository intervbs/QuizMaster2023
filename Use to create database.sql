...
(34, 21, 'Hvor høyt er Eiffeltårnet i Paris?', '324m med antennen', '315m med antennen', 'ca 300m uten antennen', 'ca 280m uten antennen', NULL, 1, 0, 1, 0, 1, 0),
(35, 21, 'I hvilket afrikansk land Kampala hovedstad?', 'Morokko', 'Pakistan', 'Uganda', 'Kenya', NULL, 0, 0, 1, 0, 1, 2),
(36, 21, 'I hvilket hav befinner Marianergropen (verdens dypeste dyphavsgrop) seg og hvor dyp er denne gropen?', 'None', 'None', 'None', 'None', NULL, 0, 0, 0, 0, 1, 1);
...
(21, 'Litt om alt', 'Denne quizzen inneholder litt om alt.', 'Litt om alt', 1, 0);
...
--
ALTER TABLE `quiz_graded`
  MODIFY `graded_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=31;
